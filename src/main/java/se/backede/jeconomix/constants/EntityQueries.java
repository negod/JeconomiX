...
public class EntityQueries {
    ...
    public static final String FIND_BUDGET_BY_QARTER = "Budget.findByQuarter";
    ...
    public static final String FIND_BUDGET_EXPENSE_BY_YEARMONTH = "Budget.findExpenseByYearMonth";
