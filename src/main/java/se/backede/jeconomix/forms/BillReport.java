...
public class BillReport extends javax.swing.JDialog {
    ...
    public BillReport(java.awt.Frame parent, boolean modal) {
        ...
        List<BillReportDto> calculatedReport = getCalculatedReport();
    ...
    public List<BillReportDto> getCalculatedReport() {
        ...
        if (allBillCategories.isPresent()) {
            ...
            for (BillCategoryDto billCategoryDto : allBillCategories.get()) {
                BillReportDto report = new BillReportDto();
                Set<CompanyDto> company = billCategoryDto.getCompany();

                if (!billCategoryDto.getName().equals("Överföringar") || !billCategoryDto.getName().equals("Lön")) {
