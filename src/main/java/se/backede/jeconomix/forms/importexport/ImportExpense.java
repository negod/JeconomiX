...
public class ImportExpense extends javax.swing.JDialog implements EventObserver {
    ...
    public void setValues(CompanyDto company) {
        ...
        if (company.getCategory() != null) {
            expenseCategoryComboBox.setSelectedItem(company.getCategory());
        }
    ...
    private void expenseCategoryComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_expenseCategoryComboBoxActionPerformed
        CategoryComboModel expModel = (CategoryComboModel) expenseCategoryComboBox.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImportExpense.class
    ...
    public void update(NegodEvent event) {
        if (event.equalsEvent(CategoryEvent.CREATE)) {
            ...
            if (category.isPresent()) {
                CategoryComboModel model = (CategoryComboModel) expenseCategoryComboBox.getModel();
