 ...
 */
public class SingleBillReport extends javax.swing.JDialog {

    /**
     * Creates new form SingleExpenseReport
     */
    BillReportDto reports;
    ...
    public SingleBillReport(java.awt.Frame parent, boolean modal, BillReportDto reports) {
        super(parent, modal);
    ...
    public void addLineChart(BillReportDto reports) {
    ...
    private DefaultCategoryDataset createDataset(BillReportDto reports) {
