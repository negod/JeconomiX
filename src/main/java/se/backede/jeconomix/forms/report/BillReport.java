...
import se.backede.jeconomix.dto.BillReportDto;
import se.backede.jeconomix.dto.TransactionDto;
import se.backede.jeconomix.models.table.BillReportModel;
...
public class BillReport extends javax.swing.JDialog {
     ...
     */
    public BillReport(java.awt.Frame parent, boolean modal, CategoryTypeEnum type) {
        super(parent, modal);
        initComponents();

        List<BillReportDto> calculatedReport = getCalculatedReport(type);
    ...
    private DefaultCategoryDataset createDataset(List<BillReportDto> reports) {
        ...
        for (Month month : monthList) {
            ...
            for (BillReportDto report : reports) {
        ...
        System.out.println(presentMonths.size());
    ...
    public void setTableData(List<BillReportDto> calculatedReport) {
        DefaultTableCellRenderer rightRenderer = new DefaultTableCellRenderer();
        rightRenderer.setHorizontalAlignment(JLabel.RIGHT);

        BillReportModel model = new BillReportModel(calculatedReport);
    ...
    public List<BillReportDto> getCalculatedReport(CategoryTypeEnum type) {

        List<BillReportDto> transactionReports = new LinkedList<>();
    ...
    private void reportTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_reportTableMouseClicked
        ...
        BillReportModel model = (BillReportModel) reportTable.getModel();
        BillReportDto transactionAt = model.getTransactionAt(selectedRow);
        new SingleBillReport(null, true, transactionAt).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillReport.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BillReport dialog = new BillReport(new javax.swing.JFrame(), true, CategoryTypeEnum.EXPENSE);
