...
public class BudgetCategoryEditor extends NegodDialog {
     ...
     */
    public BudgetCategoryEditor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BudgetCategoryEditor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BudgetCategoryEditor dialog = new BudgetCategoryEditor(new javax.swing.JFrame(), true);
