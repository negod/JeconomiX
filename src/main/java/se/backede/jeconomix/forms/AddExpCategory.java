...
public class AddExpCategory extends javax.swing.JDialog implements EventObserver {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        Dto data = new Dto(ExpenseCategoryValues.class);
        data.set(ExpenseCategoryValues.NAME, categoryInputText.getText());
        EventController.getInstance().notifyObservers(ExpenseCategoryEvent.CREATE, data);
        this.dispose();
