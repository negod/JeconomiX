...
public class ExpenseReportModel extends AbstractTableModel {
    ...
    private LinkedList<ExpenseReportDto> reports;
    private BigDecimal sum = BigDecimal.valueOf(0);

    public ExpenseReportModel(List<ExpenseReportDto> reports) {
        this.reports = new LinkedList<ExpenseReportDto>(reports);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        Object value = "";
        ExpenseReportDto report = reports.get(rowIndex);
        switch (columnIndex) {
            case 0:
     ...
     * @return
     */
    public ExpenseReportDto getTransactionAt(int row) {
