 ...
 */
public class TransactionCompanyModel extends AbstractTableModel {

    private LinkedList<TransactionDto> transactions;
    private BigDecimal sum = BigDecimal.valueOf(0);

    public TransactionCompanyModel(Set<TransactionDto> transactions) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 0:
                ...
                break;
            case 1:
                value = transaction.getCompany().getName();
                break;
            case 2:
