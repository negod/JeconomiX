 ...
 */
public class BillReportModel extends AbstractTableModel {

    private LinkedList<BillReportDto> reports;
    private BigDecimal sum = BigDecimal.valueOf(0);

    public BillReportModel(List<BillReportDto> reports) {
        this.reports = new LinkedList<BillReportDto>(reports);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        Object value = "";
        BillReportDto report = reports.get(rowIndex);
        switch (columnIndex) {
            case 0:
     ...
     * @return
     */
    public BillReportDto getTransactionAt(int row) {
